function [result,WCL,Irrigation_3] = Threshold_5_cad(ET,Precipitation,t,d)
corn_price = 0.2;
water_price =1;
...
for i = 1:5
    [Irrigation_3,WCL_3,WCL] = Irri_WCL_Predict_cad(WCL,1,Precipitation,ET,Irrigation_3,WCL_3,i);
end
